namespace NetworksApi.TCP.SERVER
{
    ...
    public class ConnectedArguments : EventArgs
    {
        ...
        public ConnectedArguments(string CLIENT_NAME, string CLIENT_IP, List<string> LIST_OF_CLIENTS, List<string> LIST_OF_IP_ADDRESSES)
        {
